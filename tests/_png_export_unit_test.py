...
def main():
    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        assert partial_snapshots[-1]["current_clip_frames"] == 8
        assert fake_progress.values[-1] == (24, 24)
    ...
    print("H3 PNG export: cached integrity, batch conversion, bounded parallel "
          "atomic saves, progress, timings, and partial recovery pass")
